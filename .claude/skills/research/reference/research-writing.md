...
> `## Connections` edge catalog) is canonical in the `implementation/domainspec`
> submodule — see References at the bottom. This repo references those cheatsheets
...
## References (ontology — canonical in the submodule)

- Frontmatter cheatsheet (`node_type`, every field/value): `implementation/domainspec/.claude/skills/custom/frontmatter.md`
- Edge catalog (`derives`/`derives-from` and the full set): `implementation/domainspec/.claude/skills/custom/edges.md`
- How to write the downstream synthesis: `./findings-writing.md`
