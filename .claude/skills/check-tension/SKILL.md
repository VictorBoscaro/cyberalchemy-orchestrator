...
retired (`.claude/skills/anti-bias-vector-composition/reference/validator-check.md` v0.3.0).
...
Owner: `.claude/skills/anti-bias-vector-composition/reference/validator-check.md` Items 1–8.
Per subject group:
