...
description: "`reading-learning-package` composes a personalized learning package from a completed `research-tower` result and source artifacts. It preserves tower evidence as source authority, uses a Whisper-compatible text intent substrate for composition, and emits traceable reading artifacts with HTML/PDF fallback behavior."
