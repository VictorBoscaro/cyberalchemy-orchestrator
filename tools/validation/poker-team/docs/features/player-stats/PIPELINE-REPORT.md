...
title: "player-stats - Pipeline Report"
...
| File | Action | Notes |
| --- | --- | --- |
| docs/features/player-stats/PIPELINE-REPORT.md | created | Per-feature post-wave pipeline record |
