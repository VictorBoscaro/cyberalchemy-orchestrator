...
title: "player-onboarding - Pipeline Report"
...
status: FLAG
pillar: operations
domain: player-onboarding-pipeline
audience:
  - developers
priority: p1
lang: en
...
# player-onboarding - Pipeline Report
...
| 9 | Verify | FLAG | medium | Non-blocking UI layering follow-up remains: POB-LDR-03. |
...
| File | Action | Notes |
| --- | --- | --- |
| docs/features/player-onboarding/PIPELINE-REPORT.md | created | Per-feature post-wave pipeline record |
