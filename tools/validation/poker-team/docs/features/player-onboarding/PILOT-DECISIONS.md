---
id: player-onboarding-pilot-decisions
feature: player-onboarding
title: Player Onboarding Pilot Decisions
summary: Decision-gate outcomes for pilot readiness profile.
status: implemented
pillar: operations
domain: player-onboarding-pilot-decisions
audience:
  - developers
  - operations
priority: p1
...
- Final LGPD legal consent text version and legal owner sign-off remain mandatory before public onboarding release.
