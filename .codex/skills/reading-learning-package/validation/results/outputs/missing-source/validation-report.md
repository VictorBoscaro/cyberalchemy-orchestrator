...
Generated: 2026-06-22T21:59:16Z
...
| --- | --- | --- |
| Source gate | block | `source-context.md` |
...
| PDF gate | block | source gate blocked before rendering |
...
- PDF renderer status: source gate blocked before rendering
