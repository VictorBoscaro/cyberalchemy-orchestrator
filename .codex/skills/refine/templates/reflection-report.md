# Refine Reflection Report

Use this report when `refine` reaches a manual, usage, output, gap, or severe-gap reflection trigger.
...
| ----- | -------- | ---------- | ---------------------- | -------------------- |
| <gap> | low      | <evidence> | <area>                 | <response>           |
...
- Outcome: no change | targeted update | major revision | hold promotion | promote
- Next lifecycle step: validate | observe | reflect | iterate | promote
