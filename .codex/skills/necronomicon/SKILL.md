---
name: necronomicon
description: "Necronomicon is the repository-local knowledge harness for Arcanum. Its MVP is an Inventory And Ontology Substrate Loop: answer what the repository already knows, what is source-backed, what is only a candidate, what conflicts, and which owner should handle the next step."
surface_kind: generated-native-runtime-package
runtime: claude
canonical_source: spells/necronomicon/README.md
alias_of: null
