...
| SWU-ACI-HOST-BUS-INTEGRITY-001 | Phase-A prerequisite maintenance | accepted Host Binding/BUS contracts + Phase-A FIX review | exact descriptor service/test/source-manifest paths | F4/F5/F6 fail closed with zero provider/tool starts | T-ACI-PHASEA-I1–I3 + focused regressions | readiness pending |
