...
engine_commit: 583683f
inputs:
  domain.md: sha256:3bcdfd9f33b8dd41ace1b084fe78205a4a0f263a02d715dc4a781f5e67de3fe5
  events.md: sha256:0e0c024c81d0fa461aece7d4cb8f95e9d0742d135052673fe69fceef2d2de1d8
  interfaces.md: sha256:56bd400ea9d8df2f511e6a8f5dbda5ab10936c9d1f8e572db94b9c226b05fe1f
  mappings.md: sha256:f68f94bc3fab24bed259d1a72a95f31b6c4a7a34269620661fcd55fc21127cd2
  operations.md: sha256:6bbb8c5cff433b825054fcaef43c582aecf60f9af16677b2f8bf8d9ea58d48b7
  queries.md: sha256:6702da6a8637130f1094c426e63ea4409bdcbf63994f8c5f339ce031d6c410bd
  rules.md: sha256:7ccc1c2a65a86d103635bf70a7f7521b444a1da9bdd880a80f071ad90a8d19c5
...
Spec-formalization metric (pure / (pure + needs_formal)): 23.5%

| Tier | Count |
| --- | --- |
| derivable-needs-harness | 676 |
| derivable-pure | 27 |
| needs-formal | 88 |
...
- Unit (derivable-pure): 27
- Integration (derivable-needs-harness): 676
- Unresolved (needs-formal): 88
...
| ACI-DOM-012 | 0f673cbe | domain-field | derivable-needs-harness | domain.md#Attempt:field:1 | Attempt.operation_id: string |
...
| ACI-DOM-018 | 162bcc89 | domain-field | derivable-needs-harness | domain.md#Attempt:field:9 | Attempt.worker_epoch: integer |
...
| ACI-DOM-019 | 1aee4c72 | domain-field | derivable-needs-harness | domain.md#Attempt:field:2 | Attempt.seat_id: [SeatId](#seatid) |
...
| ACI-RULE-003 | 2fdcd629 | rule-validation | derivable-pure | operations.md#StartAgentAttempt:rule:1 | Rule O-ATT-2: absent (existence) |
...
| ACI-DOM-047 | 34ee8b4b | domain-field | derivable-needs-harness | domain.md#Attempt:field:3 | Attempt.agent_instance_id: string |
...
| ACI-DOM-059 | 42f81641 | domain-field | derivable-needs-harness | domain.md#EffectiveInputEntry:field:0 | EffectiveInputEntry.entry_type: string (`instruction`, `history`, `context`, `reveal_message`, `tool_contract`, `response_schema`, or `adapter_wrapper`.) |
| ACI-DOM-060 | 43e8df89 | domain-field | derivable-needs-harness | domain.md#Attempt:field:5 | Attempt.adapter_ref: [VersionedReference](#versionedreference) |
...
| ACI-DOM-067 | 4dc42969 | domain-field | derivable-needs-harness | domain.md#Attempt:field:4 | Attempt.provider_ref: [VersionedReference](#versionedreference) |
...
| ACI-DOM-095 | 718a3e27 | domain-field | derivable-needs-harness | domain.md#Attempt:field:7 | Attempt.effective_input_artifact_id: [ArtifactId](#artifactid) |
...
| ACI-DOM-140 | 9b170953 | domain-field | derivable-needs-harness | domain.md#Attempt:field:6 | Attempt.model_ref: [VersionedReference](#versionedreference) |
...
| ACI-RULE-013 | cf4bee7b | rule-validation | derivable-pure | operations.md#StartAgentAttempt:rule:1 | Rule O-ATT-2: present (existence) |
...
| ACI-DOM-219 | f4561ea5 | domain-field | derivable-needs-harness | domain.md#Attempt:field:8 | Attempt.request_digest: [ContentDigest](#contentdigest) |
...
| ACI-DOM-227 | fca4522d | domain-field | derivable-needs-harness | domain.md#EffectiveInputEntry:field:6 | EffectiveInputEntry.visibility_policy_ref: [VersionedReference](#versionedreference) (Policy authorizing delivery.) |
...
needs_formal (un-formalized — no closed checkable expression): 88
...
needs-harness (derivable, requires a runtime/effect to test): 676
